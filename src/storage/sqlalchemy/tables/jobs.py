...
from sqlalchemy import ForeignKey, String, Text, Boolean, TIMESTAMP, DECIMAL
...
class Job(Base):
    ...
    salary_from: Mapped[DECIMAL] = mapped_column(DECIMAL(10, 2), comment="Минимальная зарплата", nullable=True)
    salary_to: Mapped[DECIMAL] = mapped_column(DECIMAL(10, 2), comment="Максимальная зарплата", nullable=True)
